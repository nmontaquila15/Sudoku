...
//This is the header file that contains the various template class function
//for d_matrix.cpp for Project 4b
...
// template class function for rows of puzzle
template <typename T>
...
// template class function to resize matrix
template <typename T>
